...
calculate.addEventListener("click", function(){
    ...
    fetch(url + "/latest/" + doviz1) //döviz1 e karşılık gelen diğer para birimlerine karşılık döviz kurları
        .then(res => res.json())//isteği gönderdikten sonra response alıcam ve bunu json formatına çevireceğim
        .then(data => {
